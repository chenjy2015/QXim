...
object OSUtils {
    ...
    fun check(rom: String): Boolean {
        ...
        if (!TextUtils.isEmpty((sVersion == getProp(KEY_VERSION_MIUI)).toString())) {
            sName = ROM_MIUI
        } else if (!TextUtils.isEmpty((sVersion == getProp(KEY_VERSION_EMUI)).toString())) {
            sName = ROM_EMUI
        } else if (!TextUtils.isEmpty((sVersion == getProp(KEY_VERSION_OPPO)).toString())) {
            sName = ROM_OPPO
        } else if (!TextUtils.isEmpty((sVersion == getProp(KEY_VERSION_VIVO)).toString())) {
            sName = ROM_VIVO
        } else if (!TextUtils.isEmpty((sVersion == getProp(KEY_VERSION_SMARTISAN)).toString())) {
            sName = ROM_SMARTISAN
        } else {
