...
import com.example.baselib.utils.statusbar.SystemBarTintManager.Companion.sNavBarOverride as sNavBarOverride1
...
constructor(activity: Activity) {
     ...
     * @return True if enabled, False otherwise.
     */
    private var isNavBarTintEnabled: Boolean = false
    ...
    class SystemBarConfig(
        ...
        private fun hasNavBar(context: Context): Boolean {
            ...
            if (resourceId != 0) {
                ...
                if ("1" == sNavBarOverride1) {
                    hasNav = false
                } else if ("0" == sNavBarOverride1) {
                    hasNav = true
                }
                return hasNav
            } else { // fallback
        ...
        init {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                try {
                    ...
                    m.isAccessible = true
                    sNavBarOverride1 = m.invoke(null, "qemu.hw.mainkeys") as String
                } catch (e: Throwable) {
                    sNavBarOverride1 = null
                }
